...
{
    internal class PositiveNumbersStrategy : ICalendarStrategty
    {
        ...
        public DateTime AdditionalDaysForWeekend(DateTime lastWeekDays, int remainingDays)
        {
            int additionaDays = 0;
            DateTime previousDay = lastWeekDays;
            ...
            return lastWeekDays.AddDays(additionaDays);
        }
